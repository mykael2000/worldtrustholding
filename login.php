...
<!-- Mirrored from worldtrustholding.com/login by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Oct 2025 21:44:54 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <title>Account Login - World Trust Holding</title>
    <meta charset="UTF-8">
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 to-primary-800 relative overflow-hidden">
        ...
        <div class="relative flex flex-col justify-center items-center w-full h-full text-white p-12 z-10">
            ...
            <a href="index.php" class="mb-6">
                <img src="worldtrustholding.png" alt="Logo" class="h-16 rounded-full">
            </a>
            ...
            <p class="text-xl mb-8 max-w-md text-center text-white/80">
                Swift and Secure Money Transfer to any bank account will become a breeze with World Trust Holding.
            </p>
    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 lg:p-12">
        <div class="w-full max-w-md">
            ...
            <div class="lg:hidden text-center mb-8">
                <a href="index.php">
                    <img src="worldtrustholding.png" alt="Logo" class="h-12 mx-auto">
                </a>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="px-8 pt-8 pb-6">
                    <h2 class="text-2xl font-bold text-gray-900">Sign In to World Trust Holding</h2>
                    <p class="mt-2 text-sm text-gray-600">Access the World Trust Holding panel using your email and password.</p>
                </div>
...
<!-- Mirrored from worldtrustholding.com/login by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Oct 2025 21:44:55 GMT -->
</html>
