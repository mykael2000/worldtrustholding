...
<!-- Mirrored from worldtrustholding.com/forgot-password by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Oct 2025 21:44:58 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <title>Forgot Password - World Trust Holding</title>
    <meta charset="UTF-8">
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 to-primary-800 relative overflow-hidden">
        ...
        <div class="relative flex flex-col justify-center items-center w-full h-full text-white p-12 z-10">
            ...
            <p class="text-xl mb-8 max-w-md text-center text-white/80">
                Secure access to your World Trust Holding account with our simple password recovery process.
            </p>
    ...
    <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 lg:p-12">
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <!-- Password Reset Form -->
                <div class="px-8 pb-8">
                    <form method="POST" action="https://worldtrustholding.com/forgot-password">
            ...
            <div class="mt-8 text-center">
                <p class="text-sm text-gray-600">
                    &copy; 2025 World Trust Holding. All Rights Reserved.
                </p>
            </div>
        </div>
    </div>
...
<!-- Mirrored from worldtrustholding.com/forgot-password by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Oct 2025 21:44:59 GMT -->
</html>
